...
const FoundItemsPage: React.FC = () => {
  ...
  const [filteredItems, setFilteredItems] = useState(getFoundItems());
  ...
  }, [searchQuery, category, status, getFoundItems]);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="mt-1 text-gray-600">Browse through all reported found items</p>
        </div>
      ...
      {filteredItems.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-medium text-gray-900 mb-2">No found items found</h3>
          <p className="text-gray-600 max-w-md mx-auto">
            {searchQuery || category || status 
              ? "No items match your search criteria. Try adjusting your filters."
              : "There are no found items reported yet."}
          </p>
          {(searchQuery || category || status) && (
            <Button
              variant="outline"
